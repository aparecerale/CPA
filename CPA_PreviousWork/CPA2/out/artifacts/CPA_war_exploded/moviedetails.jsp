...
<link href="css/styledetail.css" rel="stylesheet" type="text/css" media="all"/>
...
<div class="section group">
		...
		<div class="product_desc">	
			 <h2>Details :</h2>
			   <p>Avatar (marketed as James Cameron's AvataEnd Game is a 2006 American action film written and directed by Andy Cheng, and starring Cuba Gooding, Jr. as Secret Service agent Alex Thomas, who is shot in the hand while unsuccessfully trying to protect the President (Jack Scalia) from an assassin's bullet. Later, with the help of a persistent newspaper reporter named Kate Crawford (Angie Harmon), he uncovers a vast conspiracy behind what initially appeared to be a lone gunman. The film co-stars James Woods, Burt Reynolds, and Anne Archer. This film was originally set to be shown in cinemas by MGM in 2005, but was delayed by the takeover from Sony and eventually sent direct-to-DVD.r) is a 2009 American[7][8] epic science fiction film directed, written, produced, and co-edited by James Cameron, and starring Sam Worthington, Zoe Saldana, Stephen Lang, Michelle Rodriguez, and Sigourney Weaver. The film is set in the mid-22nd century, when humans are colonizing Pandora, a lush habitable moon of a gas giant in the Alpha Centauri star system, in order to mine the mineral unobtanium,[9][10] a room-temperature superconductor.[11] The expansion of the mining colony threatens the continued existence of a local tribe of Na'vi – a humanoid species indigenous to Pandora. The film's title refers to a genetically engineered Na'vi body with the mind of a remotely located human that is used to interact with the natives of Pandora.[12]</p>
	   </div>
   </div>
